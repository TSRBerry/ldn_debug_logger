...
#define AMS_LDN_IUSERLOCALCOMMUNICATION(C, H)                                                                                                                                                                              \
       ...
       AMS_SF_METHOD_INFO(C, H, 102, Result, Scan, (ams::sf::Out<s16> count, ams::sf::OutAutoSelectArray<ams::mitm::ldn::NetworkInfo> buffer, u16 channel, LdnScanFilter filter), (count, buffer, channel, filter))        \
       AMS_SF_METHOD_INFO(C, H, 103, Result, ScanPrivate, (ams::sf::Out<s16> count, ams::sf::OutAutoSelectArray<ams::mitm::ldn::NetworkInfo> buffer, u16 channel, LdnScanFilter filter), (count, buffer, channel, filter)) \
