...
#define AMS_IWLAN_LCL_MITM_SERVICE(C, H)                                                                                                                                                                                              \
    ...
    AMS_SF_METHOD_INFO(C, H, 28, Result, CreateRxEntry, (u32 in, const ams::sf::InPointerBuffer<ams::mitm::wlan::RxEntryDataBuffer> &in_buffer), (in, in_buffer))                                                                     \
    AMS_SF_METHOD_INFO(C, H, 29, Result, DeleteRxEntry, (u32 in, const ams::sf::InPointerBuffer<ams::mitm::wlan::RxEntryDataBuffer> &in_buffer), (in, in_buffer))                                                                     \
    AMS_SF_METHOD_INFO(C, H, 30, Result, AddEthertypeToRxEntry, (const ams::sf::InPointerBuffer<ams::mitm::wlan::RxEntryDataBuffer> &in_buffer, ams::sf::OutMapAliasBuffer out_buffer), (in_buffer, out_buffer))                      \
    AMS_SF_METHOD_INFO(C, H, 31, Result, DeleteEthertypeFromRxEntry, (ams::mitm::wlan::DeleteEthetypeFromRxEntryData in, const ams::sf::InMapAliasBuffer &in_array), (in, in_array))                                                  \
    ...
    AMS_SF_METHOD_INFO(C, H, 34, Result, GetScanResult, (u32 in, ams::sf::Out<u32> out, const ams::sf::InPointerBuffer<ams::mitm::wlan::ScanResultDataBuffer> &in_buffer), (in, out, in_buffer))                                      \
    ...
    AMS_SF_METHOD_INFO(C, H, 41, Result, DeleteSubtypeFromRxEntryForActionFrame, (ams::sf::Out<u32> out, ams::sf::OutPointerBuffer<ams::mitm::wlan::DeleteSubtypeFromRxEntryForActionFrameDataBuffer> out_buffer), (out, out_buffer)) \
